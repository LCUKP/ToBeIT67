...
Sukhumvit Line -> Mo Chit (N8) - On Nut (E9)
# Exclude Sena Ruam Station (N6) - does not exist.
Silom Line -> National Stadium (W1) - Saphan Taksin (S6)
Silom Line -> Saphan Taksin (S6) - Wongwian Yai (S8)

---

Section 2 - BMA Fare (Paid)

- Fare Rate -
15 Bahts for all BMA zone

Sukhumvit Line -> On Nut (E9) - Bearing (E14)
Silom Line -> Wongwian Yai (S8) - Bang Wa (S12)

---

Section 3 - BMA Fare (Free)

Sukhumvit Line -> Bearing (E14) - Kheha (E23)
Sukhumvit Line -> Mo Chit (N8) - Khu Khot (N24)
'''
